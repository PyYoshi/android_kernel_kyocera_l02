...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
#define MIPI_VIDEO_RENESAS_720P_PANEL_NAME	"mipi_video_renesas_720p"
#endif
...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
		if (!strncmp(name, MIPI_VIDEO_RENESAS_720P_PANEL_NAME,
				strnlen(MIPI_VIDEO_RENESAS_720P_PANEL_NAME,
					PANEL_NAME_MAX_LEN)))
			return 0;
#else /* CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT */
...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
static struct platform_device mipi_dsi_renesas_video_panel_device = {
...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
	platform_device_register(&mipi_dsi_renesas_video_panel_device);
#endif /* CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT */
