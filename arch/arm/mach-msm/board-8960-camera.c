...
#else
//	{144, GPIOF_OUT_INIT_LOW, 100}, /* CAM MAIN RST_N : Low - min 100us */
	{71, GPIOF_OUT_INIT_LOW, 100}, /* CAM MAIN RST_N : Low - min 100us */
    /* from Power Time'Chart */
//	{144, GPIOF_OUT_INIT_HIGH, 100}, /* CAM MAIN RST_N : High - min 100us */
	{71, GPIOF_OUT_INIT_HIGH, 100}, /* CAM MAIN RST_N : High - min 100us */
#ifdef CONFIG_OV12830
	{54, GPIOF_OUT_INIT_LOW, 100},
#endif /* CONFIG_OV12830 */
#endif
};
...
#ifdef CONFIG_OV12830
static struct msm_camera_sensor_flash_data flash_ov12830 = {
	.flash_type = MSM_CAMERA_FLASH_NONE,
};

static struct msm_camera_csi_lane_params ov12830_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0x3,
};

static struct camera_vreg_t ov12830_cam_vreg[] = {
	{"8921_lvs4", REG_VS, 0, 0, 0, 0},
	{"8921_l11", REG_LDO, 2800000, 2800000, 150000, 0},
	{"8921_l16", REG_LDO, 2800000, 2800000, 300000, 0},
};

static struct msm_camera_sensor_platform_info sensor_board_info_ov12830 = {
	.mount_angle    = 90,
	.sensor_reset   = 71,
	.gpio_conf = &msm_8960_back_cam_gpio_conf,
	.cam_vreg = ov12830_cam_vreg,
	.num_vreg = ARRAY_SIZE(ov12830_cam_vreg),
	.csi_lane_params = &ov12830_csi_lane_params,
};

struct msm_camera_sensor_info msm_camera_sensor_ov12830_data = {
	.sensor_name = "ov12830",
	.pdata = &msm_camera_csi_device_data[0],
	.flash_data = &flash_ov12830,
	.sensor_platform_info = &sensor_board_info_ov12830,
	.csi_if = 1,
	.camera_type = BACK_CAMERA_2D,
...
static struct camera_vreg_t ov9724_cam_vreg[] = {
	{"8921_l9", REG_LDO, 2800000, 2800000, 100000, 0},
	{"8921_lvs2", REG_VS, 0, 0, 0, 0},
...
//	.mount_angle    = 90,
	.mount_angle    = 270,
	.cam_vreg = ov9724_cam_vreg,
	.num_vreg = ARRAY_SIZE(ov9724_cam_vreg),
	.gpio_conf = &msm_8960_front_cam_gpio_conf,
	.csi_lane_params = &ov9724_csi_lane_params,
};

struct msm_camera_sensor_info msm_camera_sensor_ov9724_data = {
	.sensor_name    = "ov9724",
	.pdata  = &msm_camera_csi_device_data[1],
...
#ifdef CONFIG_OV12830
	{
	I2C_BOARD_INFO("ov12830", 0x48),
	.platform_data = &msm_camera_sensor_ov12830_data,
	},
#endif /* CONFIG_OV12830 */
	{
