...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8XXX_GPIO_INIT(25, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8XXX_GPIO_INIT(26, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_UP_30, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	...
	PM8XXX_GPIO_INIT(38, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8XXX_GPIO_INIT(40, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 1, PM_GPIO_PULL_NO, \
			PM_GPIO_VIN_VPH, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
