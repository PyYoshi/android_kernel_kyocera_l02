...
static struct wcd9xxx_pdata tabla20_platform_data = {
	...
	.micbias = {
		...
		.cfilt2_mv = 2700,
		.cfilt3_mv = 2000,
		.bias1_cfilt_sel = TABLA_CFILT3_SEL,
		.bias2_cfilt_sel = TABLA_CFILT2_SEL,
		.bias3_cfilt_sel = TABLA_CFILT3_SEL,
//		.bias4_cfilt_sel = TABLA_CFILT3_SEL,
	},
...
#ifdef CONFIG_OV9724
	{
		I2C_BOARD_INFO("ov9724", 0x20),
		.platform_data = &msm_camera_sensor_ov9724_data,
	},
#endif
	{
		I2C_BOARD_INFO("TDPJ3-A33A", 0xC6 >> 1),
	},
	{
		I2C_BOARD_INFO("LM3533", 0x6C >> 1),
	},
	{
		I2C_BOARD_INFO("OVM9724", 0x7A >> 1),
	},
	{
