...
{
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
	struct msm_fb_data_type *mipi_renesas_video_mfd ;
#else
...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
	mipi_renesas_video_mfd = mipi_renesas_video_get_mfd( );
	...
	if( cmd == MIPI_REFREH_SEQ_ALL ){
	  ...
	  mipi_renesas_video_refresh_exec( mipi_renesas_video_mfd );
...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
    mipi_set_tx_power_mode(0);
	ret = mipi_renesas_video_cmds_rx( &refresh_dsi_buff_rp, &dm_dsi_cmds, 1  );
#else
...
#ifndef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
#ifdef CONFIG_DISP_EXT_BOARD
static void disp_ext_reflesh_start_regist(struct work_struct *work)
{
    int panel_detect;
...
{
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
    DISP_LOCAL_LOG_EMERG("DISP disp_ext_reflesh_start\n");
    disp_ext_reflesh_set_enable( 1 );
    disp_ext_reflesh_set_start( 1 );
#else
#ifdef CONFIG_DISP_EXT_BOARD
