...
#define CFG_SET_NOTE_TAKEPIC          59
#define CFG_GET_EXP_TIME              60
#define CFG_GET_LOW_LIGHT_INFO        61
#define CFG_SET_BESTSHOT_MODE         62
#define CFG_SET_LOW_LIGHT             63
#define CFG_CANCEL_AUTO_FOCUS         64
#define CFG_SET_FOCUS_MODE            65
#define CFG_SET_CAF                   66
#define CFG_SET_TOUCH_FOCUS           67
#define CFG_SET_AEC_LOCK              68
#define CFG_SET_AWB_LOCK              69
#define CFG_GET_LENS_POSITION         70
#define CFG_CAPTURE_PRESET            71
#define CFG_CAPTURE_POSTSET           72
#define CFG_GET_IS_FLASH              73
#define CFG_AUTO_BRACKET              74
#define CFG_GET_BRACKET_EXP_TIME      75
#define CFG_SET_FLICKER               76
#define CFG_GET_ISP_SETTING           77
#define CFG_SET_FLICKER_LIB           78
#define CFG_GET_FLICKER_LIB           79
//#define CFG_MAX                       57
//#define CFG_MAX                       58
//#define CFG_MAX                       72
//#define CFG_MAX                       73
...
enum msm_v4l2_af_mode_enum_type {
    MSM_V4L2_AF_MODE_NORMAL,
    MSM_V4L2_AF_MODE_MACRO,
    MSM_V4L2_AF_MODE_AUTO,
    MSM_V4L2_AF_MODE_CAF,
    MSM_V4L2_AF_MODE_INFINITY,
};

enum msm_v4l2_output_mode_enum_type {
    MSM_V4L2_OUTPUT_MODE_2M,
    MSM_V4L2_OUTPUT_MODE_FULLHD,
    MSM_V4L2_OUTPUT_MODE_FULLHD_EX,
};

struct sensor_caf_info_t {
    enum msm_v4l2_output_mode_enum_type output_mode;
    uint8_t fd_enable;
    uint8_t mode_video;
};

struct sensor_touch_info_t{
    uint16_t x;
    uint16_t y;
    uint16_t disp_width;
...
#define  CAMERA_FLICKER_50HZ 2
#define  CAMERA_FLICKER_60HZ 1

#define  CAMERA_BS_OFF             0
#define  CAMERA_BS_AUTO            1
#define  CAMERA_BS_LANDSCAPE       2
#define  CAMERA_BS_SNOW            3
#define  CAMERA_BS_BEACH           4
#define  CAMERA_BS_SUNSET          5
#define  CAMERA_BS_NIGHT           6
#define  CAMERA_BS_PORTRAIT        7
#define  CAMERA_BS_BACKLIGHT       8
#define  CAMERA_BS_SPORTS          9
#define  CAMERA_BS_ANTISHAKE       10
#define  CAMERA_BS_FLOWERS         11
#define  CAMERA_BS_CANDLELIGHT     12
#define  CAMERA_BS_FIREWORKS       13
#define  CAMERA_BS_PARTY           14
#define  CAMERA_BS_NIGHT_PORTRAIT  15
#define  CAMERA_BS_THEATRE         16
#define  CAMERA_BS_ACTION          17
#define  CAMERA_BS_AR              18
#define  CAMERA_BS_MAPTEXT         19
#define  CAMERA_BS_MAX             20
...
struct set_flicker_data_t {
	int addr;
	int data;
};
struct get_flicker_data_t {
	int set_addr;
	int get_data;
};
...
//		uint8_t fd_enable;
		...
		uint8_t is_flash;
		int auto_bracket_value;
		uint32_t bracket_exp_time[3];
		int flicker;
		struct isp_settings_t isp_settings;
		struct set_flicker_data_t set_flicker_lib;
		struct get_flicker_data_t get_flicker_lib;
	} cfg;
};
