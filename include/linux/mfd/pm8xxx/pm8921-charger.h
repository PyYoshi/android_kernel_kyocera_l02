...
/**
 * pm8921_is_wireless_charging - get wireless charge status
 *
 */
int pm8921_is_wireless_charging(void);

/**
 * kcbms_get_substrate_therm - get substrate therm
 *
 */
int32_t kcbms_get_substrate_therm(int32_t *temp);

/**
 * kcbms_get_battery_therm - get battery therm
 *
 */
...
static inline int pm8921_is_wireless_charging(void)
{
	return 0;
}
static inline int32_t kcbms_get_substrate_therm(int32_t *temp)
{
	return -ENXIO;
}
static inline int32_t kcbms_get_battery_therm(int32_t *temp)
{
	return -ENXIO;
}
#endif
