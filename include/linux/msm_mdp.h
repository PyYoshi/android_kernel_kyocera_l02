...
#define MSMFB_CRC_GET     _IOR(MSMFB_IOCTL_MAGIC, 180, uint32_t)
#define MSMFB_CRC_RESET   _IOW(MSMFB_IOCTL_MAGIC, 181, unsigned int)

#define MSMFB_CHANGE_TRANSFER_RATE  _IOW(MSMFB_IOCTL_MAGIC, 190, uint32_t)
#define MSMFB_DISP_MSG_OUT   _IOW(MSMFB_IOCTL_MAGIC, 191, struct disp_diag_message_out)
#else
...
#ifdef CONFIG_FB_MSM_MIPI_RENESAS_VIDEO_720P_PT
#define MSMFB_GAMMA_KCJPROP_DATA_NUM 13
#else
